    ...
    <div class="modal fade" id="modal_editar_<?php echo $row['id'] ;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-body">
                ...
                <form action="functions/editar_cuenta.php" method="POST">
                    Id<br>
                    <input type="text" class="form-control form-space" name="input-id" value="<?php echo $row['id']?>" readonly/>
                    Nombre<br>
                    <input type="text" class="form-control form-space" name="input-concepto" value="<?php echo $row['nombre']?>" />
                    Saldo<br>
                    <input type="text" class="form-control form-space" name="input-importe" value="<?php echo $row['saldo']?>" />
                    Descripción<br>
                    <input type="text" class="form-control form-space" name="input-fecha" value="<?php echo $row['descripcion']?>" />                    
    ...
    <div class="modal fade" id="modal_borrar_<?php echo $row['id'] ;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                <?php echo '<a href="functions/borrar_cuenta.php?id=' . $row['id'] . '" class="btn btn-danger">Borrar</a>'; ?>
                </div>
            </div>
            </div>
        </div>
